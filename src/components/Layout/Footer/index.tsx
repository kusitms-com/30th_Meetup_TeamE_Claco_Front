    ...
    <footer className="h-[74px] w-screen max-w-[450px] text-common-white bg-[#202020] shadow-footer fixed bottom-0 z-50">
      <div className="flex justify-around space-x-5 px-5 py-[10px]">
        <div
          className={
            (cn(
              "flex-col items-center justify-center w-12 h-6 text-center cursor-pointer "
            ),
            isActive.home ? `text-primary-500` : ``)
          }
        ...
        <div
          className={
            ...
            isActive.search ? `text-primary-500` : ``)
          }
        ...
        <div
          className={
            ...
            isActive.ticket ? `text-primary-500` : ``)
          }
        ...
        <div
          className={
            ...
            isActive.user ? `text-primary-500` : ``)
          }
