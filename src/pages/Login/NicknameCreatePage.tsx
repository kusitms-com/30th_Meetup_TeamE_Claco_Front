...
export const NicknameCreatePage = () => {
    ...
    return(
        <div className='w-full h-screen bg-background-dark'>
          <div className='flex flex-col w-full h-full justify-between px-[1.25rem] pt-[9rem] pb-[4.56rem]'>
                ...
                <div className='flex flex-col gap-[0.81rem]'>
                    <div className={`flex bg-grayscale-30 justify-between rounded-[0.44rem] p-[1.06rem] border ${
                        ...
                        <input
                            ...
                            maxLength={15}
                        />
                        <span className='body4-normal text-grayscale-60'>{nickname.length}/15</span>
                    </div>
            ...
            <ConfirmButton isChecked={isChecked}>확인</ConfirmButton>
          </div>
        </div>
    )
}