...
export const MainPage = () => {
  ...
  const getItemStyle = (index: number) => {
    ...
    let style =
      "absolute w-[200px] h-[200px] bg-cover bg-center shadow-lg transition-all duration-500 ease-in-out cursor-pointer rounded-lg ";
  ...
  return (
    <main className="grid h-screen overflow-hidden place-items-center">
